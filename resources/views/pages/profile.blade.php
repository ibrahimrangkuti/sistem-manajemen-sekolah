                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="gender" id="gender" class="form-select"
                                        ...
                                        <option></option>
                                        <option value="L" {{ Auth::user()->gender == 'L' ? 'selected' : '' }}>Laki -
                                            Laki</option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="parent_gender" id="parent_gender" class="form-select"
                                            data-placeholder="Pilih Jenis Kelamin"
                                            {{ Auth::user()->parent ? 'disabled' : '' }}>
                                            <option></option>
                                            <option value="L"
                                                {{ Auth::user()->parent?->gender == 'L' ? 'selected' : '' }}>
                                                Laki - Laki</option>
                                            <option value="P"
                                                {{ Auth::user()->parent?->gender == 'P' ? 'selected' : '' }}>Perempuan
                                            </option>
                                        </select>
                                    </div>
                                </div>
